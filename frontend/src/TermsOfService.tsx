        ...
        <div className="min-h-screen flex flex-col text-slate-700 dark:text-white bg-slate-50 dark:bg-[#0f172a]">
            ...
            <div className="flex-grow p-8 md:p-12 mb-20">
                <div className="max-w-4xl mx-auto animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
                    <div className="bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 p-8 md:p-12 rounded-3xl relative overflow-hidden shadow-xl">
                        <div className="absolute top-0 right-0 w-64 h-64 bg-blue-500/5 blur-3xl rounded-full"></div>

                        <div className="prose dark:prose-invert max-w-none text-slate-600 dark:text-gray-300 leading-relaxed font-medium space-y-6 relative z-10">

                            <p className="p-4 bg-blue-50 dark:bg-white/5 border border-blue-100 dark:border-white/10 rounded-xl text-blue-700 dark:text-blue-200">
                            ...
                            <div className="flex flex-col md:flex-row gap-4 mb-8 text-sm text-gray-400 border-b border-white/10 pb-6">
                                <div><strong className="text-slate-900 dark:text-white">Last updated:</strong> February 26, 2026</div>
                                <div className="hidden md:block text-gray-300 dark:text-gray-600">•</div>
                                <div><strong className="text-slate-900 dark:text-white">Effective date:</strong> February 26, 2026</div>
                            </div>
                            ...
                            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mt-12 mb-4">2) Changes to These Terms</h2>
                            <p>
                            ...
                            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mt-12 mb-4">3) Accounts and Security</h2>
                            ...
                            <ul className="list-disc pl-6 space-y-2">
                                ...
                                <li><strong className="text-slate-900 dark:text-white">Training other systems:</strong> unless we explicitly permit it in writing, use or keep content from the Service to create, train, or improve AI/ML systems (including detectors, translation/paraphrasing systems, or comparable technologies).</li>
                            </ul>
                            <p>We may limit usage, throttle requests, or restrict access to protect users, the Service, and our systems.</p>

                            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mt-12 mb-4">5) Your Content (Input and Output)</h2>
                            ...
                            <h3 className="text-lg font-bold text-slate-800 dark:text-white mt-6 mb-2">Ownership and responsibility</h3>
                            <ul className="list-disc pl-6 space-y-2">
                            ...
                            <h3 className="text-lg font-bold text-slate-800 dark:text-white mt-6 mb-2">Accuracy</h3>
                            <p>
                            ...
                            <h3 className="text-lg font-bold text-slate-800 dark:text-white mt-6 mb-2">License to operate the Service</h3>
                            <p>
                            ...
                            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mt-12 mb-4">6) Paid Plans, Billing, and Renewals</h2>
                            ...
                            <h3 className="text-lg font-bold text-slate-800 dark:text-white mt-6 mb-2">Auto-renewal</h3>
                            <p>
                            ...
                            <h3 className="text-lg font-bold text-slate-800 dark:text-white mt-6 mb-2">Price changes</h3>
                            <p>
                            ...
                            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mt-12 mb-4">7) Third-Party Services</h2>
                            <p>
                            ...
                            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mt-12 mb-4">9) Term and Termination</h2>
                            ...
                            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mt-12 mb-4">10) Disclaimers</h2>
                            <p>
                            ...
                            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mt-12 mb-4">11) Limitation of Liability</h2>
                            ...
                            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mt-12 mb-4">12) Indemnity</h2>
                            ...
                            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mt-12 mb-4">13) Governing Law and Disputes (Simple)</h2>
                            ...
                            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mt-12 mb-4">14) Entire Agreement</h2>
                            <p>
                            ...
                            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mt-12 mb-4">16) EEA/UK Notice (Consumer Rights)</h2>
                            <p>
