        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-12 animate-fade-in-up">
            ...
            <div className="lg:col-span-2 space-y-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-6 bg-white/5 border border-white/10 p-8 rounded-[2rem]">
                    <div className="space-y-2">
                        <label className="text-sm font-semibold text-gray-400 ml-1">Select a category</label>
                        <select
                            required
                            value={category}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="space-y-2">
                            ...
                            <input
                                ...
                                className="w-full bg-[#0f172a] border border-white/10 rounded-xl px-4 py-3 text-white placeholder-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-500/50 transition-all"
                    ...
                    <div className="space-y-2">
                        ...
                        <textarea
                            ...
                            className="w-full bg-[#0f172a] border border-white/10 rounded-xl px-4 py-3 text-white placeholder-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-500/50 transition-all resize-none"
                    ...
                    <button
                        ...
                        className={`w-full py-4 rounded-xl font-bold flex items-center justify-center gap-2 transition-all ${isSubmitting
                                ...
                                : 'bg-gradient-to-r from-blue-600 to-purple-600 hover:scale-[1.02] shadow-xl shadow-blue-500/20'
                            }`}
                    >
                        {isSubmitting ? (
            ...
            <div className="space-y-6">
                ...
                <div className="bg-white/5 border border-white/10 p-6 rounded-[1.5rem] relative overflow-hidden group">
                    ...
                    <p className="text-sm text-gray-300 font-semibold mb-1">San Francisco</p>
                    <p className="text-sm text-gray-400 leading-relaxed">Market St, Suite 1200, San Francisco, CA 94103</p>
                    <p className="text-sm text-gray-400">United States of America</p>
                </div>
            </div>
        </div>
    );
