                ...
                <div className="absolute right-0 mt-3 w-72 bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded-2xl shadow-2xl overflow-hidden animate-fade-in z-[100]">
                    <div className="p-2 space-y-1">
                        ...
                        {!isAuthenticated ? (
                            ...
                            >
                                <div className="w-8 h-8 flex items-center justify-center rounded-lg group-hover:bg-blue-50 dark:group-hover:bg-blue-500/10 transition-colors">
                                ...
                                <div className="w-8 h-8 flex items-center justify-center">
                                    {theme === 'dark' ? (
                                        ...
                                        <svg className="w-6 h-6 text-amber-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 3v1m0 16v1m9-9h1m-19 0h1m3.34 7.08l.707.707m12.728-12.728l.707.707M6.34 6.34l.707.707m12.728 12.728l.707.707M12 8a4 4 0 100 8 4 4 0 000-8z" />
                                        </svg>
                                    )}
                                </div>
