...
function App() {
  ...
  const getScoreColor = (score: number, label: string) => {
    // If AI, high score is bad (red). If Human, high score is good (green).
    // wait, probability is confidence in the label.
    // If label is 'ai', prob 0.99 -> Very likely AI (Red)
    // If label is 'human', prob 0.99 -> Very likely Human (Green)
