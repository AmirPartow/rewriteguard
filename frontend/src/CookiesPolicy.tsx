                    ...
                    <div className="prose prose-invert max-w-none text-gray-300 leading-relaxed">
                        ...
                        <div className="bg-white/5 border border-white/10 p-6 rounded-2xl mb-12">
                            ...
                            <ul className="space-y-2 text-blue-400 font-medium">
                                <li><a href="#background" className="hover:text-blue-300 transition-colors">Background</a></li>
                                <li><a href="#types-of-cookies" className="hover:text-blue-300 transition-colors">Types of Cookies</a></li>
                                <li><a href="#interest-based-ads" className="hover:text-blue-300 transition-colors">Information About Interest-Based Advertisements</a></li>
                                <li><a href="#manage-cookies" className="hover:text-blue-300 transition-colors">How to Manage Cookies</a></li>
                                <li><a href="#dnt-signals" className="hover:text-blue-300 transition-colors">Do Not Track Signals</a></li>
                                <li><a href="#changes" className="hover:text-blue-300 transition-colors">Changes to this Cookie Policy</a></li>
                                <li><a href="#list-cookies" className="hover:text-blue-300 transition-colors">List of Cookies, Purpose, and Storage Periods</a></li>
                            </ul>
                        </div>

                        <h2 id="background" className="text-2xl font-bold text-white mt-12 mb-4 border-b border-white/10 pb-2">Background</h2>
                        <p className="mb-4">
                        ...
                        <h2 id="types-of-cookies" className="text-2xl font-bold text-white mt-12 mb-4 border-b border-white/10 pb-2">Types of Cookies</h2>
                        ...
                        <div className="space-y-6">
                            ...
                            <div>
                                <h3 className="text-xl font-semibold text-white mb-2">Advertising / Marketing Cookies</h3>
                        ...
                        <h2 id="interest-based-ads" className="text-2xl font-bold text-white mt-12 mb-4 border-b border-white/10 pb-2">Information About Interest-Based Advertisements</h2>
                        <p className="mb-4">
                        ...
                        <h2 id="manage-cookies" className="text-2xl font-bold text-white mt-12 mb-4 border-b border-white/10 pb-2">How to Manage Cookies</h2>
                        ...
                        <div className="bg-white/5 p-6 rounded-xl border border-white/10 mb-6">
                            <h4 className="font-bold text-white mb-2">Analytics (measurement tools):</h4>
                            ...
                            <h4 className="font-bold text-white mb-2">Advertising / Social media platforms (interest-based ads):</h4>
                        ...
                        <h2 id="dnt-signals" className="text-2xl font-bold text-white mt-12 mb-4 border-b border-white/10 pb-2">Do Not Track Signals</h2>
                        ...
                        <h2 id="changes" className="text-2xl font-bold text-white mt-12 mb-4 border-b border-white/10 pb-2">Changes to this Cookie Policy</h2>
                        ...
                        <h2 id="list-cookies" className="text-2xl font-bold text-white mt-12 mb-4 border-b border-white/10 pb-2">List of Cookies, Purpose, and Storage Periods</h2>
